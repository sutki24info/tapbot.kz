...
- **[Мастер-структура документации](README.md)** - координация всей документации
- **[История проекта](history.md)** - ключевые вехи и решения
- **[Конфигурации серверов](../infrastructure/servers.md)** - техническое железо
- **[Программный стек](../architecture/stack.md)** - архитектура ПО
- **[Backup процедуры](../guides/operations/backup-procedures.md)** - процедуры восстановления
