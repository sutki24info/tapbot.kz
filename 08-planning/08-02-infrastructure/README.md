...
-  [02\.02 - Ресурсы и производительность](./../../02-infrastructure/02-02-resources/README) - текущее состояние ресурсов и мониторинг

-  [03\.01 - Архитектурные принципы](./../../03-software-stack/03-01-architecture/README) - основы архитектуры для планирования

-  [05\.02 - Безопасность серверов](./../../05-security/05-02-server-security/README) - планы развития безопасности

-  [06\.02 - Операции и деплоймент](./../../06-operations/06-02-deployment/README) - операционные аспекты планирования
