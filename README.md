...
**tapbot.kz** - это инновационная платформа для автоматизации бизнес-процессов в Казахстане через AI-ботов в Telegram.
...
| **🤖 AI Expert** | Claude.ai | - | DevOps, автоматизация |
...
|------|--------|-----------|-------|
| 04.07.2025 | v1.0 | Создание базовой структуры репозитория | Кадырхан + Claude.ai |
| 03.07.2025 | v0.9 | Завершение настройки второго сервера | Кадырхан + Claude.ai |
| 01.07.2025 | v0.8 | Настройка Directus + PostgreSQL | Кадырхан + Claude.ai |
