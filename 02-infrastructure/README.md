...
-  [03 - Программный стек](./../03-software-stack/README) - приложения и сервисы

-  [04 - Сетевая архитектура](./../04-network-architecture/README) - домены и networking

-  [05 - Безопасность](./../05-security/README) - защита инфраструктуры

-  [06 - Операции](./../06-operations/README) - мониторинг и поддержка

-  [08 - Планирование](./../08-planning/README) - стратегическое развитие

## 📞 Поддержка и контакты

**Провайдер услуг:** beget.com\
**Техническая поддержка:** tech@tapbot.kz\
**Экстренные проблемы:** См. [06\.03 - Мониторинг](./../06-operations/06-03-monitoring/README)\
**Планирование upgrade:** См. [02\.02 - Ресурсы](./02-02-resources/README)
