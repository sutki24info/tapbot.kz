...
-  [03\.01 - Архитектурные принципы](./../../03-software-stack/03-01-architecture/README.md) - общая архитектура решения

-  [04\.03 - Управление портами](./../../04-network-architecture/04-03-port-management/README.md) - сетевая конфигурация

-  [05\.02 - Безопасность серверов](./../../05-security/05-02-server-security/README.md) - защита инфраструктуры

-  [08\.02 - Планы развития инфраструктуры](./../../08-planning/08-02-infrastructure/README.md) - стратегические планы
